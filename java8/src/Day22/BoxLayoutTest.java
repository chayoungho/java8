...
public class BoxLayoutTest extends JFrame {
	...
	public static void main(String[] args) {
		BoxLayoutTest bit = new BoxLayoutTest();
		bit.setDefaultCloseOperation(EXIT_ON_CLOSE);
		bit.setSize(400, 200);
		bit.setVisible(true);
	}
